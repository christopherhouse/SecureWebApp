...
resource applicationGateways_cmh_bplus_loc_appgw_name_resource 'Microsoft.Network/applicationGateways@2023-09-01' = {
  ...
  properties: {
    ...
    gatewayIPConfigurations: [
      {
        ...
        //id: '${applicationGateways_cmh_bplus_loc_appgw_name_resource.id}/gatewayIPConfigurations/appGatewayIpConfig'
        id: resourceId('Microsoft.Network/applicationGateways/gatewayIPConfigurations', appGatewayName, 'appGatewayIpConfig')
        properties: {
          subnet: {
            id: appGwSubnet.id
          }
    ...
    sslCertificates: [
      {
        name: 'www'
        //id: '${applicationGateways_cmh_bplus_loc_appgw_name_resource.id}/sslCertificates/www'
        id: resourceId('Microsoft.Network/applicationGateways/sslCertificates', appGatewayName, 'www')
        properties: {
